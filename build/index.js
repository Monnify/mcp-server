...
import { assertEnvironmentConsistency, isOperationAllowed, } from "./security/guards.js";
...
export const server = new Server({ name: "monnify-mcp", version: "1.0.0" }, { capabilities: { tools: {} } });
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        ...
        return errorResult(`Internal error in "${name}". Check server logs.`);
    }
});
