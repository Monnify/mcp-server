...
KEY OUTPUT FIELDS: accountName (name of account holder), accountNumber, bankCode, bankName.`,
    inputSchema: zodToJsonSchema(VerifyBankAccountInputSchema),
};
async function handler(args) {
    try {
        const parsed = VerifyBankAccountInputSchema.parse(args);
        const result = await apiGet("/api/v1/disbursements/account/validate", {
...
//# sourceMappingURL=verifyBankAccount.js.map