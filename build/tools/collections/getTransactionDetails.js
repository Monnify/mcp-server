...
const InputSchema = z.object({
    transactionReference: z
        .string()
        .min(1)
        .describe("Monnify-generated transaction reference (e.g. 'MNFY|67|20220725111957|000283'). Returned as transactionReference from monnify_initiate_payment or monnify_get_all_transactions."),
});
const definition = {
...
async function handler(args) {
    try {
        ...
        const result = await apiGet(`/api/v2/transactions/${encodeURIComponent(parsed.transactionReference)}`);
